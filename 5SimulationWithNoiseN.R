...
for (i in 1:10) {
  ...
  withnoisenorm_data1$random <- rnorm(2500, mean = 0.2, sd = 1)
...
for (i in 1:10) {
  ...
  withnoisenorm_data2$random <- rnorm(2500, mean = 0.4, sd = 1)
...
compareplot_imp(withnoisenorm1, withnoisenorm2, "Nwithnoisenorm.png")
...
for (i in 1:10) {
  ...
  withnoisebinom_data1$random <- rnorm(2500)
...
for (i in 1:10) {
  ...
  withnoisebinom_data2$random <- rnorm(2500)
...
compareplot_imp(withnoisebinom1, withnoisebinom2, "Nwithnoisebinom.png")
...
for (i in 1:10) {
  ...
  withnoisecat_data1$random <- rnorm(2500)
...
for (i in 1:10) {
  ...
  withnoisecomb_data1$random <- rnorm(2500, mean = 0.2, sd = 1)
...
for (i in 1:10) {
  ...
  withnoisecomb_data2$random <- rnorm(2500, mean = 0.4, sd = 1)
...
compareplot_imp(withnoisecomb1, withnoisecomb2, "Nwithnoisecomb.png")
